...
Runs the full 9-fold anchored forward cross-validation pipeline on
the FI-2010 benchmark dataset:
  ...
  - Stage 5: Aggregate and report metrics across all folds
...
def main():
    """Run the full 9-fold experiment pipeline."""
